...
namespace Marshmallow\GoogleAdsLeadExtention\App;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Mail;
use Marshmallow\GoogleAdsLeadExtention\App\Mail\GoogleAdsLeadExtentionNotifier;

class GoogleAdsLeadExtentionBase 
{
	private $request;
	...
	{
		$send_mail_to = config('google-ads-lead-extention.conversion-email-address');
		if ($send_mail_to) {
			Mail::to($send_mail_to)->send(new GoogleAdsLeadExtentionNotifier($this));
		}
	}
}